...
@property (nonatomic, strong) UIColor *selectionIndicatorColor;//选中条颜色
@property (nonatomic, strong) UIColor *selectionTitleColor;//选中的title字体颜色
@property (nonatomic, strong) UIColor *nomalTitleColor;//未选中title字体颜色
